// ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/StructuralBenchmarks/ComparableBenchmarks.swift.gyb", line: 1)
import Benchmark
import StructuralCore
import StructuralExamples

// ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/StructuralBenchmarks/ComparableBenchmarks.swift.gyb", line: 6)

func specializedLess(_ l: Point1, _ r: Point1) -> Bool {
    // ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/StructuralBenchmarks/ComparableBenchmarks.swift.gyb", line: 12)
    if l._1 < r._1 {
        return true
        // ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/StructuralBenchmarks/ComparableBenchmarks.swift.gyb", line: 15)
    } else {
        return false
    }
}
...
func specializedLess(_ l: Point2, _ r: Point2) -> Bool {
    ...
    if l._1 < r._1 {
        return true
        // ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/StructuralBenchmarks/ComparableBenchmarks.swift.gyb", line: 10)
    } else
    // ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/StructuralBenchmarks/ComparableBenchmarks.swift.gyb", line: 12)
    if l._2 < r._2 {
        return true
...
// ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/StructuralBenchmarks/ComparableBenchmarks.swift.gyb", line: 21)

let comparableBenchmarks = BenchmarkSuite(name: "Comparable") { suite in
    // ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/StructuralBenchmarks/ComparableBenchmarks.swift.gyb", line: 24)
    ...
    suite.benchmark("Point1 (generic)") {
        boolSink = p1_1.genericLess(p1_2)
    }
    ...
    suite.benchmark("Point2 (generic)") {
        boolSink = p2_1.genericLess(p2_2)
    }
    ...
    suite.benchmark("Point4 (generic)") {
        boolSink = p4_1.genericLess(p4_2)
    }
    ...
    suite.benchmark("Point5 (generic)") {
        boolSink = p5_1.genericLess(p5_2)
    }
    ...
    suite.benchmark("Point6 (generic)") {
        boolSink = p6_1.genericLess(p6_2)
    }
    ...
    suite.benchmark("Point7 (generic)") {
        boolSink = p7_1.genericLess(p7_2)
    }
    ...
    suite.benchmark("Point8 (generic)") {
        boolSink = p8_1.genericLess(p8_2)
    }
    ...
    suite.benchmark("Point9 (generic)") {
        boolSink = p9_1.genericLess(p9_2)
    }
    ...
    suite.benchmark("Point10 (generic)") {
        boolSink = p10_1.genericLess(p10_2)
    }
    ...
    suite.benchmark("Point11 (generic)") {
        boolSink = p11_1.genericLess(p11_2)
    }
    ...
    suite.benchmark("Point12 (generic)") {
        boolSink = p12_1.genericLess(p12_2)
    }
    ...
    suite.benchmark("Point13 (generic)") {
        boolSink = p13_1.genericLess(p13_2)
    }
    ...
    suite.benchmark("Point14 (generic)") {
        boolSink = p14_1.genericLess(p14_2)
    }
    ...
    suite.benchmark("Point15 (generic)") {
        boolSink = p15_1.genericLess(p15_2)
    }
    ...
    suite.benchmark("Point16 (generic)") {
        boolSink = p16_1.genericLess(p16_2)
    }

    // ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/StructuralBenchmarks/ComparableBenchmarks.swift.gyb", line: 34)
}
