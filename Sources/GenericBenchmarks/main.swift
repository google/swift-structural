...
benchmark("additive arithmetic - binary tree - generic") {
    tree1 = tree1 + tree1
}

var tree2: BinaryTree<Double> = .branch(.leaf(1), 2, .branch(.leaf(3), 4, .leaf(5)))

benchmark("additive arithmetic - binary tree - specialized") {
    tree2 = specializedAdd(tree2, tree2)
}

var p1 = Point3(x: 10, y: 20, z: 30)

benchmark("additive arithmetic - point3 - generic") {
    p1 = p1 + p2
}

var p2 = Point3(x: 10, y: 20, z: 30)

benchmark("additive arithmetic - point3 - specialized") {
