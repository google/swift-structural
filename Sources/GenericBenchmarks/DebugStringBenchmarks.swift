// ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/GenericBenchmarks/DebugStringBenchmarks.swift.gyb", line: 1)
import Benchmark
import GenericCore
...
let debugStringBenchmarks = BenchmarkSuite(name: "DebugString") { suite in
    ...
    // ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/GenericBenchmarks/DebugStringBenchmarks.swift.gyb", line: 8)

    suite.benchmark("Point1 (generic)") {
        stringSink = p1_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point2 (generic)") {
        stringSink = p2_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point4 (generic)") {
        stringSink = p4_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point5 (generic)") {
        stringSink = p5_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point6 (generic)") {
        stringSink = p6_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point7 (generic)") {
        stringSink = p7_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point8 (generic)") {
        stringSink = p8_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point9 (generic)") {
        stringSink = p9_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point10 (generic)") {
        stringSink = p10_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point11 (generic)") {
        stringSink = p11_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point12 (generic)") {
        stringSink = p12_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point13 (generic)") {
        stringSink = p13_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point14 (generic)") {
        stringSink = p14_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point15 (generic)") {
        stringSink = p15_1.debugDescriptionGeneric
    }
    ...
    suite.benchmark("Point16 (generic)") {
        stringSink = p16_1.debugDescriptionGeneric
    }
    ...
    // ###sourceLocation(file: "/usr/local/google/home/shabalin/swift-libs/swift-shaped/Sources/GenericBenchmarks/DebugStringBenchmarks.swift.gyb", line: 18)
